...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, eps=1e-7):
    ...
    # Get the coordinates of bounding boxes 格式转换
    ...
    # （可选）计算 GIoU（解决不相交问题）/ DIoU（考虑中心点距离）/ CIoU（DIoU + 长宽比惩罚）
    ...
    # torch.Tensor (shape=(n,)) 返回 box1 和 box2 中每个框的 IoU（或 GIoU/DIoU/CIoU）值。
    return iou  # IoU
"""
"-----------------------------------------------------原始CIOU结束-----------------------------------------------------"
